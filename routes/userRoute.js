...
import { CurrentUser, UpdateCurrentUser, addAcount, verifyBankAccount, transferFunds } from "../controllers/User/User.js"
...
router.post("/api/v1/transfer-funds", ValidateToken, transferFunds)
